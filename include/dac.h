...
class Dac {
 ...
 public:
  ...
  ///
  float SetVoltage(uint8_t channel, float voltage);
  ///
 ...
 protected:
  ...
  /// a three-byte message msg_ that writes to the dac register.
  /// Each DAC has its own convertion function. Check the datasheet of each chip
  /// and override the function below accordingly.
  ///
  virtual void VoltageToBytes(uint8_t channel, float voltage) = 0;
  ///
